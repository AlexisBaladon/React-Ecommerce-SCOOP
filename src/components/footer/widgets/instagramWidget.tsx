interface IProps {
  ...
  const InstagramWidget = ({id, color, width, height}: IProps) => {
    return <svg id={id} xmlns="http://www.w3.org/2000/svg" 
                viewBox="0 0 512.000000 512.000000"  width={width} height={height}>
